...
function onClear(slot_data)
    ...
    if Transition then
        ...
        if Tracker:FindObjectForCode("portal_rando").CurrentStage == 0 then
            ...
            Portals:SetDestination("3","Searing Crags - Portal")
            Portals:SetDestination("4","Glacial Peak - Portal")
            Portals:SetDestination("5","Riviere Turquoise - Portal")
            Portals:SetDestination("6","Sunken Shrine - Portal")
        end
        Portals:OpenPortal("1")
        Portals:OpenPortal("2")
        Portals:OpenPortal("3")
        if Tracker:FindObjectForCode("num_portals").AcquiredCount == 6 then
            Portals:OpenPortal("4")
