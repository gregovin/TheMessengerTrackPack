function GetStorageItem()
    local GenericStorageItem = class()

    function GenericStorageItem:init() end

    function GenericStorageItem:createItem(name)
    ...
    function GenericStorageItem:canProvideCode(code)
        return false
    end
    ...
    function GenericStorageItem:load(data)
        return true
    end
